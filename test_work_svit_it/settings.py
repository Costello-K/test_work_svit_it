"""
Django settings for test_work_svit_it project.
...
ROOT_URLCONF = 'test_work_svit_it.urls'
...
WSGI_APPLICATION = 'test_work_svit_it.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('PSQL_NAME', BASE_DIR/'db.sqlite3'),
